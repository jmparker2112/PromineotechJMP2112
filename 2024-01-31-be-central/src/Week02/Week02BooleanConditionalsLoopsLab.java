...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		//		c. Use a conditional to print the following based on the following conditions:
		...
		double billTotal = 1000.0;
		double adjustedTotal = (billTotal - (billTotal * loyaltyMemberDiscount));
		
		System.out.println("You're adjusted total is: " + adjustedTotal);
		
		if (adjustedTotal > 500) {
			if (loyaltyMemberStatus == "SILVER") {
				loyaltyMemberStatus = "GOLD";
				System.out.println("Congratulations! You have achieved a loyalty level of: " + loyaltyMemberStatus);
